...
bad_word = {
	"[6b8][il1!|ïîìí¡¦]*[t%+7][cç€©]h", #bitch
	"[6b8][il1!|ïîìí¡¦]*[sz5$§]h",
	"[6b8][il1!|ïîìí¡¦]*[t%+7]s*h*",
	"[f][uüûùúµaâäàåæáã@4]*[qckç€©]", #fuck
	"[a@4^âäàåæáã]*[sz5$§][sz5$§][sz5$§]*", #ass
	"[sz5$§]h[il1!|ïîìí¡¦]*[t%+7]", #shit
	"[6b8][a@4^âäàåæáã]*[sz5$§]*[t%+7][a@4^âäàåæáã]*rd", #bastard
	"r[e3êëèæ€]*[t%+7][a@4^âäàåæáã]*rd", #r slur
	"[qcç€©k][uüûùúµ]*n[t%+7]", #cunt
	"d[il1!|ïîìí¡¦]*[qcç€©k]", #dick
	"p[uüûùúµ]*[sz5$§][sz5$§]*[yÿ¥µŸý]", #pussy
	"v[a@4^âäàåæáã]*g", #vag
	"[6b8][o0ôöòó•Ø][o0ôöòó•Ø][o0ôöòó•Ø]*[6b8]", #boob
	"n[il1!|ïîìí¡¦]*gg*[e3êëèæ€aâäàåæáã@4^uüûùúµ]r?", #n slur
	"[t%+7][il1!|ïîìí¡¦]*[t%+7]", #tit
	"[6b8][e3êëèæ€]*[a@4^âäàåæáãe3êëèæ€]n[e3êëèæ€uüûùúµa@4^âäàåæáãr]r", #beaner
	"[6b8][il1!|ïîìí¡¦]*[o0ôöòó•Ø]*wj[o0ôöòó•Ø]*[6b8]", #blowjob
	"[6b8][o0ôöòó•Ø]*n[e3êëèæ€uüûùúµa@4^aâäàåæáã]r", #boner
	"[6b8][uüûùúµ][t%+7][t%+7]", #butt
	"[cç€©k][il1!|ïîìí¡¦]*[il1!|ïîìí¡¦]*[t%+7]", #clit
	"[cç€©k][o0ôöòó•Ø]*[cç€©kq]", #cock
	"[kcç€©g][o0ôöòó•Ø]*[o0ôöòó•Ø]*[t%+t]", #cooch
	"[kcç€©g][o0ôöòó•Ø]*[o0ôöòó•Ø]*[cç€©]h",
	"[kcç€©g][o0ôöòó•Ø]*[o0ôöòó•Ø]*[t%+t][cç€©]h",
	"[kcç€©g][o0ôöòó•Ø]*[o0ôöòó•Ø]*n", #c slur
	"[cç€©k][uüûùúµ]m", #cum
	"[cç€©k][uüûùúµ]n[il1!|ïîìí¡¦]*[il1!|ïîìí¡¦]*?[il1!|ïîìí¡¦]*ng[uüûùúµ][sz5$§]", #cunnillingus
	"d[yÿ¥µŸýil1!|ïîìí¡¦]k[e3êëèæ€]*", #d slur
	"d[o0ôöòó•Ø]*[o0ôöòó•Øuüûùúµ][cç€©]h", #douche
	"d[o0ôöòó•Ø]*[o0ôöòó•Øuüûùúµ][sz5$§]h", #douche
	"[f][a@4^âäàåæáã]*g", #f slur
	"g[a@4^âäàåæáã]*[ÿ¥µŸý]", #gay
	"h[a@4^âäàåæáã]*ndj[o0ôöòó•Ø]*[6b8]", #handjob
	"h[a@4^âäàåæáã]*rd[o0ôöòó•Ø]*n", #hardon
	"h[o0ôöòó•Ø]*",#hoe
	"h[o0ôöòó•Ø]*m[o0ôöòó•Ø]*", #homo
	"h[uüûùúµ]mp", #hump
	"[jg][il1!|ïîìí¡¦]*z", #jizz
	"[il1!|ïîìí¡¦]*[e3êëèæ€]*[sz5$§][6b8]", #lesbian
	"n[uüûùúµ][t%+7][sz5$§][a@4^âäàåæáã]*[cç€©kq]", #nutsack
	"p[il1!|ïîìí¡¦]*[sz5$§][sz5$§]", #piss
	"q[uüûùúµ][e3êëèæ€]*[e3êëèæ€]*f", #queef
	"[sz5$§][e3êëèæ€]*x", #sex
	"q[uüûùúµ][e3êëèæ€]*[e3êëèæ€a@4^âäàåæáã]r", #queer
	"r[il1!|ïîìí¡¦]*mj[o0ôöòó•Ø]*[6b8]", #rimjob
	"[sz5$§]h[il1!|ïîìí¡¦]*[o0ôöòó•Ø]*ng", #schlong
	"[sz5$§][cç€©]h[il1!|ïîìí¡¦]*[o0ôöòó•Ø]*ng",
	"[sz5$§][cç€©kq][a@4^âäàåæáã]*n[cç€©kq]", #skank
	"h[o0ôöòó•Ø]*r[e3êëèæ€]*", #whore
	"[sz5$§][il1!|ïîìí¡¦]*[uüûùúµ]h?[t%+7]", #slut
	"[t%+7][e3êëèæ€]*[sz5$§][t%+7][il1!|ïîìí¡¦]*[cç€©kq][il1!|ïîìí¡¦]*[e3êëèæ€]*", #testicles
	"[t%+7]w[a@4^âäàåæáã]*[t%+7]", #twat
	"v[a@4^âäàåæáã]*j[a@4^âäàåæáã]*[ÿ¥µŸý]j[a@4^âäàåæáã]*y",#vajayjay
	"w[a@4^âäàåæáã]*n[cç€©k]", #wank
	"w[e3êëèæ€]*[t%+7][6b8][a@4^âäàåæáã]*[cç€©kq]", #wetback
	"pn[il1!|ïîìí¡¦]*[sz5$§]", #penis
	"h[o0ôöòó•Ø]*[6b8][a4@^âäàåæáã]g", #hobag
	"[cç€©=<o0ôöòó•Ø6b8]=[38bdo0ôöòó•Ø>]", #c==3
	"[sz5$§][uüûùúµ][cç€©kq] m[ÿ¥µŸý]", #suck my
	"w[e3êëèæ€]*[e3êëèæ€]*w[e3êëèæ€]*[e3êëèæ€]*", #weewee
	"p[o0ôöòó•Ø]*rn", #porn
	"[a@4^âäàåæáã]*n[uüûùúµ][sz5$§]", #anus
	"[a@4^âäàåæáã]*n[a@4^âäàåæáãuüûùúµ][il1!|ïîìí¡¦]", #anal
	"pr[il1!|ïîìí¡¦]*[cç€©kq]", #prick
	"ph[a@4^âäàåæáã]*[il1!|ïîìí¡¦]*[il1!|ïîìí¡¦]*?[il1!|ïîìí¡¦]*[cç€©]" #phalic
}
